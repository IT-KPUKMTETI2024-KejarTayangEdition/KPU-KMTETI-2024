...
export default function About() {
  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <Image alt="" className="mt-12 lg:mt-24" style={preventImageDrag} src={imgPatternMerge} />
      ...
      <div data-aos="fade-up" data-aos-duration="700" className="mt-12 lg:mt-24 w-full flex flex-col h-auto justify-center items-center">
        ...
        <Slider>
          {path.map((p, k) => (
            <Image alt="" key={k} className="h-40 mobile-m:h-[11rem] mobile-l:h-64 md:h-80 lg:h-92" src={p} />
            ))}
        </Slider>
      </div>

      <Image alt="" className="mt-12 lg:mt-24" style={preventImageDrag}  src={imgPattern} />
    </div>
  )
}